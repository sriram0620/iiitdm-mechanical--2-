...
export function ThermalEngineeringHero() {
    ...
    <section className="relative overflow-hidden">
      ...
      <div className="container relative z-10 pt-24 pb-32">
        ...
        <div className="flex items-center text-white/70 text-sm mb-8">
          ...
          <ChevronRight className="h-4 w-4 mx-2" />
          <span className="text-white font-medium">Thermal Engineering Division</span>
        </div>

        <div className="max-w-4xl">
          <Badge className="mb-4 bg-white text-primary hover:bg-white/90 px-3 py-1 text-sm">Division</Badge>

          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 tracking-tight">
            Thermal <span className="text-secondary">Engineering</span>
          </h1>

          <p className="text-xl text-white/90 mb-8 max-w-3xl leading-relaxed">
            Exploring the intricacies of heat, energy transfer, and fluid dynamics to revolutionize industries and
          ...
          <div className="flex flex-wrap gap-4 mt-8">
            ...
            <Button
              onClick={() => scrollToSection("energy-systems")}
              className={`rounded-full transition-all ${
                activeSection === "energy-systems"
                  ? "bg-white text-primary hover:bg-white/90"
                  : "bg-white/20 text-white hover:bg-white/30"
              }`}
            >
            ...
            <Button
              onClick={() => scrollToSection("fluid-dynamics")}
              className={`rounded-full transition-all ${
                activeSection === "fluid-dynamics"
                  ? "bg-white text-primary hover:bg-white/90"
                  : "bg-white/20 text-white hover:bg-white/30"
              }`}
            >
        ...
        <div className="absolute bottom-0 right-0 transform translate-y-1/2">
          <div className="relative">
            ...
            <div className="absolute -top-10 -left-10 w-20 h-20 border-2 border-secondary/40 rounded-full"></div>
            <div className="w-60 h-60 bg-gradient-to-br from-white/10 to-secondary/20 backdrop-blur-sm rounded-2xl p-6 flex items-center justify-center">
              <Flame className="h-24 w-24 text-white/80" />
            </div>
          </div>
        </div>
      </div>
      ...
      >
        <div className="container py-3 flex items-center justify-between">
          <h2 className="text-lg font-bold text-primary">Thermal Engineering Division</h2>
          <div className="flex gap-4">
            ...
            <Button
              ...
              size="sm"
              onClick={() => scrollToSection("energy-systems")}
              className={activeSection === "energy-systems" ? "text-secondary" : "text-primary"}
            >
              Energy Systems
            </Button>
            <Button
              ...
              size="sm"
              onClick={() => scrollToSection("fluid-dynamics")}
              className={activeSection === "fluid-dynamics" ? "text-secondary" : "text-primary"}
            >
              Fluid Dynamics
            </Button>
          </div>
