...
import { ChevronRight, Compass, Lightbulb, Pencil, Shapes } from "lucide-react"
import { Badge } from "@/components/ui/badge"
import { Button } from "@/components/ui/button"
import Link from "next/link"

export function DesignDivisionHero() {
    ...
    <section className="relative overflow-hidden">
      ...
      <div className="container relative z-10 pt-24 pb-32">
        ...
        <div className="flex items-center text-white/70 text-sm mb-8">
          ...
          <ChevronRight className="h-4 w-4 mx-2" />
          <span className="text-white font-medium">Design Division</span>
        </div>
        ...
        <div className="max-w-4xl">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 tracking-tight">
            Design <span className="text-secondary">Division</span>
          </h1>

          <p className="text-xl text-white/90 mb-8 max-w-3xl leading-relaxed">
            Where visionary researchers, aspiring engineers, and technology enthusiasts converge to shape the future of
            engineering design and redefine the boundaries of robotics and automation.
          </p>
          ...
          <div className="flex flex-wrap gap-4 mt-8">
            ...
            <Button
              onClick={() => scrollToSection("design-concepts")}
              className={`rounded-full transition-all ${
      ...
      >
        <div className="container py-3 flex items-center justify-between">
          <h2 className="text-lg font-bold text-primary">Design Division</h2>
          <div className="flex gap-4">
            ...
            <Button
              ...
              size="sm"
              onClick={() => scrollToSection("design-concepts")}
              className={activeSection === "design-concepts" ? "text-secondary" : "text-primary"}
            >
              Design Concepts
            </Button>
            <Button
              ...
              size="sm"
              onClick={() => scrollToSection("robotics")}
              className={activeSection === "robotics" ? "text-secondary" : "text-primary"}
            >
              Robotics & Automation
            </Button>
          </div>
